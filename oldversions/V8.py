...
class Background:
    def __init__(self, maps, block_sprites, block_color_values, block_offsets):
        ...
        self.color = block_sprites['block'].get_at((0, 0))
...
title_sprites_raw = sprite_sheet.get_sprites(farthest_y_coordinate=110, all_coordinates=((317, 161),), update=False)
